...
public interface StepValidationListener {
    ...
    //Informs the library that the step is valid/not valid
    //If the step was in a state of validation, the library will handle putting the step in a state
    //of false for a validation state
